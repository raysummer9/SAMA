...
urlpatterns = [
    ...
    path('attendance-session/<str:session_id>/', views.view_attendance_session, name='view_attendance_session'),
    ...
    path('end-attendance-session/<str:session_id>/', views.end_attendance_session, name='end_attendance_session'),
    path('attendance-report/', views.attendance_report, name='attendance_report'),
    path('student-attendance-report/<int:student_id>/', views.student_attendance_report, name='student_attendance_report'),
]
